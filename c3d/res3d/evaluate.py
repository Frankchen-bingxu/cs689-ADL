from res3d.drn import  Residual_DenseNet
import numpy as np
import cv2
import os
...
if __name__ == '__main__':
    root_path = '/Users/chenbingxu/PycharmProjects/c3d/ucfimgs/'
    ...
    model = Residual_DenseNet(nb_classes=6, input_shape=(112, 112, 8, 3))
    model.load_weights('/Users/chenbingxu/PycharmProjects/c3d/res3d/results/weights_drn3d.h5')
