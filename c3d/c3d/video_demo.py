...
def main():
    with open('ucfTrain/classInd.txt', 'r') as f:
    ...
    model.summary()
    model.load_weights('c3d/results/weights_c3d_101.h5', by_name=True)

    # read video
    video = 'video_test/crwaling_baby_test4.mp4'
    cap = cv2.VideoCapture(video)#read the frame of the video

    clip = []
    submit = './babyCrawling_test5.json'
